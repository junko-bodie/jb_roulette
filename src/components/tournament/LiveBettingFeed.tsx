        ...
        <AnimatePresence initial={false}>
          {events.slice(0, 6).map((event) => (
            ...
            >
              {/* Player color dot */}
              <div
                className="w-1.5 h-1.5 rounded-full flex-shrink-0 ring-1 ring-white/10"
              ...
              <div className="flex items-baseline gap-1.5 flex-1 min-w-0">
                <span
                  ...
                  style={{ color: event.color || 'rgba(255,255,255,0.95)' }}
                >
                  {event.username}
                </span>
              ...
              {/* Amount */}
              <span
                className="text-[14px] font-bold tabular-nums text-white flex-shrink-0"
                style={{ fontFamily: FONTS.primary }}
              >
