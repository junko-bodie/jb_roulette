    ...
    >
      ...
      <nav className="w-full bg-black/60 backdrop-blur-2xl border-b border-white/5 sticky top-0 z-50 flex justify-center">
        <div className="w-full max-w-7xl px-4 sm:px-12 h-14 sm:h-20 flex items-center justify-between">
          ...
          <div className="flex flex-col items-center text-center">
             <h1 className="text-[10px] sm:text-[13px] font-black uppercase tracking-[0.3em] sm:tracking-[0.5em] text-white/40 mb-0.5 sm:mb-1">Global Wealth</h1>
             <div className="flex items-center gap-2 sm:gap-3">
               <Globe size={10} className="text-gold/50" />
               <span className="text-[9px] sm:text-[11px] font-black text-gold uppercase tracking-[0.2em] sm:tracking-[0.4em]">Worldwide Registry</span>
             </div>
          </div>

          <div className="flex items-center gap-3 sm:gap-10 min-w-0 sm:min-w-[120px] justify-end">
            <Link href="/rankings" className="text-[10px] sm:text-[13px] font-black uppercase tracking-[0.2em] sm:tracking-[0.3em] text-white/40 hover:text-gold transition-colors whitespace-nowrap">Season Pts</Link>
      ...
      <main className="w-full max-w-5xl px-4 sm:px-10 py-8 sm:py-16 flex flex-col items-center">
        ...
        <div className="flex flex-col items-center mb-6 sm:mb-12 text-center w-full">
          <div className="flex items-center gap-3 sm:gap-5 mb-2 sm:mb-4 justify-center">
             <Users size={20} className="text-gold/40 sm:hidden" />
             <Users size={32} className="text-gold/40 hidden sm:block" />
             <h2 className="text-xl sm:text-3xl font-black uppercase tracking-[0.3em] sm:tracking-[0.5em] text-white/95 leading-none">Wealth Registry</h2>
          </div>
          <div className="flex flex-col items-center gap-2 sm:gap-4">
             <p className="text-[10px] sm:text-[12px] font-black text-white/20 uppercase tracking-[0.2em] sm:tracking-[0.4em] max-w-xl leading-loose">
             ...
             <div className="flex items-center gap-2 sm:gap-3 mt-1 sm:mt-2">
                ...
                <span className="text-[9px] sm:text-[11px] font-black text-emerald-500/80 uppercase tracking-[0.2em] sm:tracking-[0.4em]">Protocol Sync Active</span>
             </div>
          </div>
        </div>
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="border-b border-white/10 bg-white/[0.05]">
                ...
                <th className="py-3 sm:py-6 px-2 sm:px-4 text-[9px] sm:text-[12px] font-black uppercase tracking-[0.2em] sm:tracking-[0.5em] text-white/40 text-center hidden sm:table-cell">Tier</th>
                <th className="py-3 sm:py-6 px-2 sm:px-4 text-[9px] sm:text-[12px] font-black uppercase tracking-[0.2em] sm:tracking-[0.5em] text-white/40 text-center hidden md:table-cell">Status</th>
                <th className="py-3 sm:py-6 px-3 sm:px-12 text-[9px] sm:text-[12px] font-black uppercase tracking-[0.2em] sm:tracking-[0.5em] text-white/40 text-right">Net Worth</th>
              </tr>
            </thead>
                  ...
                  >
                    ...
                    <td className="py-3 sm:py-6 px-2 sm:px-4">
                      <div className="flex items-center gap-2 sm:gap-6">
                        <div className={`w-8 h-8 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl bg-white/[0.05] border-2 flex items-center justify-center transition-all overflow-hidden flex-shrink-0 ${
                        ...
                        <div className="flex flex-col min-w-0">
                          <div className="flex items-center gap-1 sm:gap-3">
                            ...
                            {player.is_pro && (
                              <ShieldCheck className="w-3 h-3 sm:w-4 sm:h-4 text-emerald-500 flex-shrink-0" />
                            )}
                          </div>
                    ...
                    <td className="py-3 sm:py-6 px-2 sm:px-4 hidden sm:table-cell">
                       <div className="flex justify-center">
                         {player.balance > 100000 ? (
                            <div className="px-2 sm:px-3 py-1 bg-gold/10 border border-gold/30 rounded-lg text-[8px] sm:text-[10px] font-black text-gold uppercase tracking-widest">Grandmaster</div>
                         ) : player.balance > 10000 ? (
                            <div className="px-2 sm:px-3 py-1 bg-white/5 border border-white/10 rounded-lg text-[8px] sm:text-[10px] font-black text-white/30 uppercase tracking-widest">Veteran</div>
                         ) : (
                            <div className="px-2 sm:px-3 py-1 bg-white/[0.02] border border-white/[0.03] rounded-lg text-[8px] sm:text-[10px] font-black text-white/10 uppercase tracking-widest">Rookie</div>
                         )}
                       </div>
                    </td>
                    <td className="py-3 sm:py-6 px-2 sm:px-4 hidden md:table-cell">
                    ...
                    <td className="py-3 sm:py-6 px-3 sm:px-12 text-right">
                       <span className={`text-lg sm:text-3xl font-black tabular-nums leading-none ${isMe ? 'text-gold' : 'text-white'}`} style={{ fontFamily: FONTS.primary }}>
      ...
      <footer className="fixed bottom-6 sm:bottom-12 left-1/2 -translate-x-1/2 z-50 w-[calc(100%-32px)] sm:w-auto max-w-lg sm:max-w-none">
         <motion.div 
           ...
           className="bg-black/80 backdrop-blur-3xl border border-white/20 px-4 sm:px-12 py-4 sm:py-6 rounded-xl sm:rounded-2xl flex items-center justify-center gap-4 sm:gap-12 shadow-[0_40px_80px_rgba(0,0,0,0.9)]"
         >
            <div className="flex items-center gap-2 sm:gap-4">
               ...
               <span className="text-[9px] sm:text-[11px] font-black uppercase tracking-[0.3em] sm:tracking-[0.5em] text-white/50 italic leading-none">Global Assets</span>
            </div>
            <div className="h-4 sm:h-6 w-px bg-white/10" />
            <Link href="/rankings" className="group flex items-center gap-2 sm:gap-4">
               <span className="text-[9px] sm:text-[11px] font-black uppercase tracking-[0.3em] sm:tracking-[0.5em] text-gold group-hover:text-white transition-colors leading-none">Season Rankings</span>
